...
function TodoItem({todoItem, nameTODO, indicatorTODO, idTODO}) {
        ...
        <div data-cy={`todo-item-${todoItem}`} className="w-full p-2 mb-3 flex justify-between items-center bg-white min-h-[80px] rounded-[12px]">
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <svg data-cy='todo-item-edit-button' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[16px] h-[16px] text-[#C4C4C4] cursor-pointer">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                    </svg>
                </div>
            </div>
            <div>
                <svg data-cy='todo-item-delete-button' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
